        ...
        <>
            ...
            <main className="container mx-auto bg-white">
                ...
                <div className="flex justify-center my-5">
                    <form action="/download" method="get" className="join w-11/12 max-w-3xl mx-auto block mt-2">
                        <input
                            ref={inputRef}
                        ...
                        <button className="join-item btn btn-primary text-base-100" type="submit">
                            Download
                        </button>
                    </form>
                </div>
